...
$content = $content -replace "department: 'planning'", "department: 'general_office'"

# Fix 2: Replace the corrupted departments array
$oldDepartments = @'
const departments = [
  // 鎬荤粡鍔?
...
# Replace old departments with new departments
...
Write-Host "Fix 1 and 2 completed"
